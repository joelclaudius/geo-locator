...
const Footer = () => {
  ...
  return (
    <footer className="bg-footer-one text-white p-8 grid md:grid-cols-2 lg:grid-cols-2 lg:gap-3 lg:py-10  lg:px-[500px]">
        ...
        >
          <div className="grid grid-cols-1">
            <div>
              ...
              <input
                ...
                required
                className="bg-white text-blue-900 border rounded-lg text-left p-2"
              />
            </div>
            <div>
          ...
          <div className="col-span-2">
            ...
            <textarea
              ...
              required
              rows="4"
              className="bg-white text-blue-900 border rounded-lg text-left p-2 w-full"
            />
          </div>
          <div className="col-span-2">
            <button
